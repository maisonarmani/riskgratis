...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
    ...
    var e = Math.PI / 180, t = 180 / Math.PI, r = /[achlmqstvz]|(-?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
        o = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi, n = /(^[#\.]|[a-y][a-z])/gi, i = /[achlmqstvz]/gi,
        a = /[\+\-]?\d*\.?\d+e[\+\-]?\d+/gi, s = _gsScope._gsDefine.globals.TweenLite, h = "codepen",
        f = "MorphSVGPlugin", g = String.fromCharCode(103, 114, 101, 101, 110, 115, 111, 99, 107, 46, 99, 111, 109),
        u = String.fromCharCode(47, 114, 101, 113, 117, 105, 114, 101, 115, 45, 109, 101, 109, 98, 101, 114, 115, 104, 105, 112, 47),
        d = function (e) {
            return true;
        }(window ? window.location.host : ""), l = function (e) {
            _gsScope.console && console.log(e)
        }, c = function (t, r) {
            var o, n, i, a, s, h, f = Math.ceil(Math.abs(r) / 90), g = 0, u = [];
            ...
            if (r !== f || o !== g) {
                ...
                var u = a % 360 * e, d = Math.cos(u), l = Math.sin(u), p = (r - f) / 2, C = (o - g) / 2, m = d * p + l * C,
                    S = -l * p + d * C, w = n * n, x = i * i, y = m * m, _ = S * S, v = y / w + _ / x;
                v > 1 && (n = Math.sqrt(v) * n, i = Math.sqrt(v) * i, w = n * n, x = i * i);
                var b = s === h ? -1 : 1, M = (w * x - w * _ - x * y) / (w * _ + x * y);
                0 > M && (M = 0);
                var A = b * Math.sqrt(M), T = A * (n * S / i), O = A * -(i * m / n), N = (r + f) / 2, L = (o + g) / 2,
                    D = N + (d * T - l * O), q = L + (l * T + d * O), z = (m - T) / n, G = (S - O) / i, R = (-m - T) / n,
                    P = (-S - O) / i, k = Math.sqrt(z * z + G * G), B = z;
                b = 0 > G ? -1 : 1;
                ...
                var F, j, Q, I = c(E, V), Y = d * n, X = l * n, W = l * -i, H = d * i, U = I.length - 2;
            ...
            var t, o, n, i, s, h, f, g, u, d, c, C, m, S = (e + "").replace(a, function (e) {
                ...
                }).match(r) || [], w = [], x = 0, y = 0, _ = S.length, v = 2, b = 0;
            if (!e || !isNaN(S[0]) || isNaN(S[1]))return l("ERROR: malformed path data: " + e), w;
            for (t = 0; _ > t; t++)if (m = s, isNaN(S[t]) ? (s = S[t].toUpperCase(), h = s !== S[t]) : t--, n = +S[t + 1], i = +S[t + 2], h && (n += x, i += y), 0 === t && (g = n, u = i), "M" === s) f && f.length < 8 && (w.length -= 1, v = 0), x = g = n, y = u = i, f = [n, i], b += v, v = 2, w.push(f), t += 2, s = "L"; else if ("C" === s) f || (f = [0, 0]), f[v++] = n, f[v++] = i, h || (x = y = 0), f[v++] = x + 1 * S[t + 3], f[v++] = y + 1 * S[t + 4], f[v++] = x += 1 * S[t + 5], f[v++] = y += 1 * S[t + 6], t += 6; else if ("S" === s) "C" === m || "S" === m ? (d = x - f[v - 4], c = y - f[v - 3], f[v++] = x + d, f[v++] = y + c) : (f[v++] = x, f[v++] = y), f[v++] = n, f[v++] = i, h || (x = y = 0), f[v++] = x += 1 * S[t + 3], f[v++] = y += 1 * S[t + 4], t += 4; else if ("Q" === s) d = n - x, c = i - y, f[v++] = x + 2 * d / 3, f[v++] = y + 2 * c / 3, h || (x = y = 0), x += 1 * S[t + 3], y += 1 * S[t + 4], d = n - x, c = i - y, f[v++] = x + 2 * d / 3, f[v++] = y + 2 * c / 3, f[v++] = x, f[v++] = y, t += 4; else if ("T" === s) d = x - f[v - 4], c = y - f[v - 3], f[v++] = x + d, f[v++] = y + c, d = x + 1.5 * d - n, c = y + 1.5 * c - i, f[v++] = n + 2 * d / 3, f[v++] = i + 2 * c / 3, f[v++] = x = n, f[v++] = y = i, t += 2; else if ("H" === s) i = y, f[v++] = x + (n - x) / 3, f[v++] = y + (i - y) / 3, f[v++] = x + 2 * (n - x) / 3, f[v++] = y + 2 * (i - y) / 3, f[v++] = x = n, f[v++] = i, t += 1; else if ("V" === s) i = n, n = x, h && (i += y - x), f[v++] = n, f[v++] = y + (i - y) / 3, f[v++] = n, f[v++] = y + 2 * (i - y) / 3, f[v++] = n, f[v++] = y = i, t += 1; else if ("L" === s || "Z" === s) "Z" === s && (n = g, i = u, f.closed = !0), ("L" === s || Math.abs(x - n) > .5 || Math.abs(y - i) > .5) && (f[v++] = x + (n - x) / 3, f[v++] = y + (i - y) / 3, f[v++] = x + 2 * (n - x) / 3, f[v++] = y + 2 * (i - y) / 3, f[v++] = n, f[v++] = i, "L" === s && (t += 2)), x = n, y = i; else if ("A" === s) {
                if (C = p(x, y, 1 * S[t + 1], 1 * S[t + 2], 1 * S[t + 3], 1 * S[t + 4], 1 * S[t + 5], (h ? x : 0) + 1 * S[t + 6], (h ? y : 0) + 1 * S[t + 7]))for (o = 0; o < C.length; o++)f[v++] = C[o];
                x = f[v - 2], y = f[v - 1], t += 7
            } else l("Error: malformed path data: " + e);
            return w.totalPoints = b + v, w
        }, m = function (e, t) {
            var r, o, n, i, a, s, h, f, g, u, d, l, c, p, C = 0, m = .999999, S = e.length, w = t / ((S - 2) / 6);
            for (c = 2; S > c; c += 6)for (C += w; C > m;)r = e[c - 2], o = e[c - 1], n = e[c], i = e[c + 1], a = e[c + 2], s = e[c + 3], h = e[c + 4], f = e[c + 5], p = 1 / (Math.floor(C) + 1), g = r + (n - r) * p, d = n + (a - n) * p, g += (d - g) * p, d += (a + (h - a) * p - d) * p, u = o + (i - o) * p, l = i + (s - i) * p, u += (l - u) * p, l += (s + (f - s) * p - l) * p, e.splice(c, 4, r + (n - r) * p, o + (i - o) * p, g, u, g + (d - g) * p, u + (l - u) * p, d, l, a + (h - a) * p, s + (f - s) * p), c += 6, S += 6, C--;
            return e
        }, S = function (e) {
            var t, r, o, n, i = "", a = e.length, s = 100;
            for (r = 0; a > r; r++) {
            ...
            var t, r = e.length, o = 0, n = 0;
            for (t = 0; r > t; t++)o += e[t++], n += e[t];
            return [o / (r / 2), n / (r / 2)]
        }, y = function (e) {
            var t, r, o, n = e.length, i = e[0], a = i, s = e[1], h = s;
            for (o = 6; n > o; o += 6)t = e[o], r = e[o + 1], t > i ? i = t : a > t && (a = t), r > s ? s = r : h > r && (h = r);
            return e.centerX = (i + a) / 2, e.centerY = (s + h) / 2, e.size = (i - a) * (s - h)
        }, _ = function (e) {
            for (var t, r, o, n, i, a = e.length, s = e[0][0], h = s, f = e[0][1], g = f; --a > -1;)for (i = e[a], t = i.length, n = 6; t > n; n += 6)r = i[n], o = i[n + 1], r > s ? s = r : h > r && (h = r), o > f ? f = o : g > o && (g = o);
            return e.centerX = (s + h) / 2, e.centerY = (f + g) / 2, e.size = (s - h) * (f - g)
        }, v = function (e, t) {
            return t.length - e.length
        }, b = function (e, t) {
            var r = e.size || y(e), o = t.size || y(t);
            ...
            var i, a, s, h, f = e.length, g = 0, u = f - 2;
            for (r *= 6, a = 0; f > a; a += 6)i = (a + r) % u, h = e[i] - (t[a] - o), s = e[i + 1] - (t[a + 1] - n), g += Math.sqrt(s * s + h * h);
            return g
        }, T = function (e, t, r) {
            var o, n, i, a = e.length, s = x(e), h = x(t), f = h[0] - s[0], g = h[1] - s[1], u = A(e, t, 0, f, g), d = 0;
            for (i = 6; a > i; i += 6)n = A(e, t, i / 6, f, g), u > n && (u = n, d = i);
            if (r)for (o = e.slice(0), w(o), i = 6; a > i; i += 6)n = A(o, t, i / 6, f, g), u > n && (u = n, d = -i);
            return d / 6
        }, O = function (e, t, r) {
            for (var o, n, i, a, s, h, f = e.length, g = 99999999999, u = 0, d = 0; --f > -1;)for (o = e[f], h = o.length, s = 0; h > s; s += 6)n = o[s] - t, i = o[s + 1] - r, a = Math.sqrt(n * n + i * i), g > a && (g = a, u = o[s], d = o[s + 1]);
            return [u, d]
        }, N = function (e, t, r, o, n, i) {
            var a, s, h, f, g, u = t.length, d = 0, l = Math.min(e.size || y(e), t[r].size || y(t[r])) * o,
                c = 999999999999, p = e.centerX + n, C = e.centerY + i;
            ...
            var n, i, a, s, h, f, g, u = t.length - e.length, d = u > 0 ? t : e, c = u > 0 ? e : t, p = 0,
                C = "complexity" === o ? v : b, S = "position" === o ? 0 : "number" == typeof o ? o : .8, x = c.length,
                A = "object" == typeof r && r.push ? r.slice(0) : [r], L = "reverse" === A[0] || A[0] < 0, D = "log" === r;
            if (c[0]) {
                if (d.length > 1 && (e.sort(C), t.sort(C), f = d.size || _(d), f = c.size || _(c), f = d.centerX - c.centerX, g = d.centerY - c.centerY, C === b))for (x = 0; x < c.length; x++)d.splice(x, 0, N(c[x], d, x, S, f, g));
                if (u)for (0 > u && (u = -u), d[0].length > c[0].length && m(c[0], (d[0].length - c[0].length) / 6 | 0), x = c.length; u > p;)s = d[x].size || y(d[x]), a = O(c, d[x].centerX, d[x].centerY), s = a[0], h = a[1], c[x++] = [s, h, s, h, s, h, s, h], c.totalPoints += 8, p++;
            ...
            if (!t)return e;
            var r, n, i, a = e.match(o) || [], s = a.length, h = "";
            for ("reverse" === t ? (n = s - 1, r = -2) : (n = (2 * (parseInt(t, 10) || 0) + 1 + 100 * s) % s, r = 2), i = 0; s > i; i += 2)h += a[n - 1] + "," + a[n] + " ", n = (n + r) % s;
            return h
        }, G = function (e, t) {
            var r, o, n, i, a, s, h, f = 0, g = parseFloat(e[0]), u = parseFloat(e[1]), d = g + "," + u + " ", l = .999999;
            for (n = e.length, r = .5 * t / (.5 * n - 1), o = 0; n - 2 > o; o += 2) {
                if (f += r, s = parseFloat(e[o + 2]), h = parseFloat(e[o + 3]), f > l)for (a = 1 / (Math.floor(f) + 1), i = 1; f > l;)d += (g + (s - g) * a * i).toFixed(2) + "," + (u + (h - u) * a * i).toFixed(2) + " ", f--, i++;
                d += s + "," + h + " ", g = s, u = h
            }
            return d
        }, R = function (e) {
            var t = e[0].match(o) || [], r = e[1].match(o) || [], n = r.length - t.length;
            ...
            var r, o = _gsScope.document.createElementNS("http://www.w3.org/2000/svg", "path"),
                n = Array.prototype.slice.call(e.attributes), i = n.length;
    ...
    F.pathFilter = D, F.pointsFilter = R, F.subdivideRawBezier = m, F.defaultMap = "size", F.pathDataToRawBezier = function (e) {
        ...
        var r, o, n, i, a, h, f, g, u = C(E(e, !0))[0] || [], d = 0;
        if (t = t || {}, g = t.align || t.relative, i = t.matrix || [1, 0, 0, 1, 0, 0], a = t.offsetX || 0, h = t.offsetY || 0, "relative" === g || g === !0 ? (a -= u[0] * i[0] + u[1] * i[2], h -= u[0] * i[1] + u[1] * i[3], d = "+=") : (a += i[4], h += i[5], g && (g = "string" == typeof g ? s.selector(g) : g && g[0] ? g : [g], g && g[0] && (f = g[0].getBBox() || {
                    x: 0,
                    y: 0
                }, a -= f.x, h -= f.y))), r = [], n = u.length, i && "1,0,0,1,0,0" !== i.join(","))for (o = 0; n > o; o += 2)r.push({
            x: d + (u[o] * i[0] + u[o + 1] * i[2] + a),
            y: d + (u[o] * i[1] + u[o + 1] * i[3] + h)
        }); else for (o = 0; n > o; o += 2)r.push({x: d + (u[o] + a), y: d + (u[o + 1] + h)});
        return r
    }
