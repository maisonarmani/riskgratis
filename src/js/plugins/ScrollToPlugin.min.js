...
(_gsScope._gsQueue || (_gsScope._gsQueue = [
  ...
  d = _gsScope._gsDefine.plugin({
    ...
    init: function (a, d, e) {
      ...
      null != d.x ? (this._addTween(this, 'x', this.x, 'max' === d.x ? c(a, 'x')  : d.x, 'scrollTo_x', !0), this._overwriteProps.push('scrollTo_x'))  : this.skipX = !0,
      null != d.y ? (this._addTween(this, 'y', this.y, 'max' === d.y ? c(a, 'y')  : d.y, 'scrollTo_y', !0), this._overwriteProps.push('scrollTo_y'))  : this.skipY = !0,
      !0
    },
    set: function (a) {
      ...
      this.x < 0 && (this.x = 0),
      this.y < 0 && (this.y = 0),
      this._autoKill && (!this.skipX && (g > 7 || - 7 > g) && d < c(this._target, 'x') && (this.skipX = !0), !this.skipY && (f > 7 || - 7 > f) && e < c(this._target, 'y') && (this.skipY = !0), this.skipX && this.skipY && (this._tween.kill(), this.vars.onAutoKill && this.vars.onAutoKill.apply(this.vars.onAutoKillScope || this._tween, this.vars.onAutoKillParams || []))),
